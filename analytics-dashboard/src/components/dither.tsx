...
class RetroEffectImpl extends Effect {
  constructor(props?: { colorNum?: number; pixelSize?: number }) {
    const uniforms = new Map<string, THREE.Uniform>([
      ["colorNum", new THREE.Uniform(props?.colorNum ?? 4.0)],
      ["pixelSize", new THREE.Uniform(props?.pixelSize ?? 2.0)]
    ]);
...
export default function Dither({
  ...
  return (
    <Canvas className={styles.container} camera={{ position: [0, 0, 6] }} dpr={1} gl={{ antialias: true, preserveDrawingBuffer: true }}>
      <DitheredWaves
        waveSpeed={waveSpeed}
